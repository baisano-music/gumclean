    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-center gap-6 md:gap-2">
          {STEPS.map((step, i) => (
            <div key={step.title} className="flex flex-col md:flex-row items-center flex-1">
              <div className="bg-white rounded-[2rem] p-8 border-2 border-green-dark/20 shadow-lg flex-1 w-full">
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-green-dark text-white font-[family-name:var(--font-fredoka)] font-bold text-lg mb-4">
                  {i + 1}
                </div>
                <h3 className="font-[family-name:var(--font-fredoka)] text-xl font-bold text-green-dark mb-3">
                  {step.title}
                </h3>
              ...
              {i < STEPS.length - 1 && (
                <div
                  className="flex items-center justify-center p-2 text-green-dark text-3xl font-bold shrink-0"
                  aria-hidden="true"
                >
                  <svg
        ...
        <div className="mt-12 flex justify-center">
          <div className="inline-flex items-center gap-3 bg-green-dark/10 text-green-dark font-semibold px-6 py-3 rounded-full border border-green-dark/20 text-sm sm:text-base">
            <svg
